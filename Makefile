...
PROJECT_REPO ?= github.com/cloudhippie/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.2.1

export TERRAFORM_PROVIDER_SOURCE ?= ansible/ansible
export TERRAFORM_PROVIDER_REPO ?= https://github.com/ansible/terraform-provider-ansible
export TERRAFORM_PROVIDER_VERSION ?= 1.1.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-ansible
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/ansible/terraform-provider-ansible/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-ansible_v$(TERRAFORM_PROVIDER_VERSION)
...
REGISTRY_ORGS ?= xpkg.upbound.io/cloudhippie
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/cloudhippie
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/cloudhippie
XPKGS = $(PROJECT_NAME)
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/ansibles/01-delete.yaml.tmpl.
